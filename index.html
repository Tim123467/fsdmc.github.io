...
<body>
    <div class="welcome-message">
        ...
        <div class="button-container">
            <a href="https://fsdmc.us.to/archive" class="button"><img src="https://fsdmc.github.io/docs/assets/Vector1.png" class="icon">View Archive</a>
            <a href="/discord" class="button"><img src="https://fsdmc.github.io/docs/assets/Vector5.png" class="icon">Join Discord</a>
            <a href="https://fsdmc.us.to/contact" class="button"><img src="https://fsdmc.github.io/docs/assets/Vector2.png" class="icon">Contact Us</a>
        </div>
    </div>
    <footer>
